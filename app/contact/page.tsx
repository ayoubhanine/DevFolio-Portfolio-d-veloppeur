    ...
    return(
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Coordonnées</h2>
            <p className="text-slate-600">
              Je suis actuellement disponible pour de nouvelles opportunités en tant que développeur.
            </p>
          ...
          {/* Liens Sociaux */}
          <div>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Réseaux Sociaux</h2>
            <div className="flex gap-4">
              ...
              <a 
                href="https://linkedin.com/in/ayoub-hanine" 
                target="_blank" 
